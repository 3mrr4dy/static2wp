...
if ( defined( 'WP_CLI' ) && WP_CLI ) {
	require_once S2WP_PLUGIN_DIR . 'includes/class-s2wp-cli.php';
	WP_CLI::add_command( 's2wp', 'S2WP_CLI' );
}
 ...
 * Boot the plugin.
 */
function s2wp_load_textdomain() {
	load_plugin_textdomain( 'static2wp', false, dirname( plugin_basename( S2WP_PLUGIN_FILE ) ) . '/languages' );
}
add_action( 'init', 's2wp_load_textdomain', 0 );
